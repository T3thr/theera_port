        ...
        <nav className="top-0 left-0 w-full bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white shadow-lg z-50">
            <div className="container mx-auto flex items-center justify-between px-6 py-4">
                ...
                <div
                    ...
                    } lg:flex lg:space-x-8 absolute lg:static top-16 left-0 w-full lg:w-auto bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white shadow-md lg:shadow-none lg:bg-transparent py-4 lg:py-0 z-50`}
                >
                    {[
